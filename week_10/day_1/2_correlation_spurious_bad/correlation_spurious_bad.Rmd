...
Be cautious of the difference between percentage point change and percentage change and what is being shown in the results of an analysis. Both calculate the change in a dataset but percent change refers to the rate of change, whereas percentage point change measures the actual amount of change.

If we come back to our poll example, let's say we repeated the survey after some intervention and $950$ people answered 'yes' - the percentage change is 5.6% ($\frac{950-900}{900}*100\%$) but the percentage point change is calculated by subtracting the old percentage from the new, in our case would be 5 percentage point (p.p.) change. $(\frac{950}{1000}-\frac{900}{1000})*100\%$