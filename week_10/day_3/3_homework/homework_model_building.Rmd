...
house_sales <- read_csv("data/kc_house_data.csv")

# latitude and longitude are probably better explained by zip code so remove these - REVERSE

# id doesn't tell us anything - remove 

unique(house_sales$waterfront)

# make waterfront logical

# make yr_renovated into renovated - logical

# grade and condition into ordinal variables 

glimpse(house_sales)

house_sales_trim <- house_sales %>%
...
```{r}
alias(price ~ ., data = house_sales_trim)

# sqft_basement is correlated sqft_living and sqft_above

house_sales_trim<- house_sales_trim %>%
